...
<head>
  ...
  <title>MediNova — Smart Healthcare</title>
    ...
    <form id="login-form" class="auth-form active">
      ...
      <div class="form-group">
        ...
        <div style="display:flex; gap:8px; align-items:center">
          ...
          <button type="button" class="btn ghost" onclick="togglePw('login-password')" title="Show/Hide">👁</button>
        </div>
      </div>
    ...
    <form id="signup-form" class="auth-form">
      ...
      <div class="form-group">
        ...
        <div style="display:flex; gap:8px; align-items:center">
          ...
          <button type="button" class="btn ghost" onclick="togglePw('signup-password')" title="Show/Hide">👁</button>
        </div>
      </div>
      <div class="form-group">
...
<aside class="sidebar" aria-label="Primary Navigation" style="display:none">
  ...
  <ul class="side-nav">
    ...
    <li><a href="#mental"><i class="fas fa-smile"></i> <span data-i18n="nav_wellbeing">Well‑being</span></a></li>
...
<div id="main-app" style="display: none;">
    ...
    <div class="wrap row">
      ...
      <nav aria-label="Primary Navigation">
        <ul class="menu" role="menubar">
          ...
          <li role="none">
            <button role="menuitem" aria-haspopup="true"><i class="fas fa-concierge-bell"></i> Services ▾</button>
          ...
          <li role="none">
            <button role="menuitem" aria-haspopup="true"><i class="fas fa-heartbeat"></i> Health ▾</button>
            <div class="dropdown" role="menu">
          ...
          <li role="none">
            <button role="menuitem" aria-haspopup="true"><i class="fas fa-smile"></i> Well‑being ▾</button>
            <div class="dropdown" role="menu">
      ...
      <div class="row" role="toolbar" aria-label="Accessibility Controls">
        <a class="btn sos" href="#emergency" onclick="sos()" title="SOS — Call Ambulance" data-i18n-title="sos_title" style="background:#ff2d55; color:#fff; border-color:rgba(255,255,255,.2)"><i class="fas fa-exclamation-triangle"></i> SOS</a>
  ...
  <main id="app" class="wrap">
    ...
    <section id="home" class="page active" aria-labelledby="home-title">
      <div class="hero">
        <div>
          <span class="badge">💡 <span data-i18n="tagline">Smart care, simple clicks.</span></span>
          <h1 id="home-title" data-i18n="hero">Your one‑stop smart healthcare companion.</h1>
          <p class="lead" data-i18n="lead">Book doctors, track health, learn, and get help—securely and accessibly.</p>
          <div class="cta">
      ...
      <div class="grid" aria-label="Highlights">
        <div class="card span-4">
          ...
          <p class="muted">Local‑first demo: your inputs stay in your browser. Not a medical diagnosis.</p>
        </div>
        <div class="card span-4">
        ...
        <div class="card span-4">
          <h3><i class="fas fa-brain"></i> Well‑being</h3>
    ...
    <datalist id="titleOptions">
      ...
      <option value="X‑Ray Chest"></option>
    ...
    <section id="symptom" class="page" aria-labelledby="sym-title">
      <h2 id="sym-title"><i class="fas fa-stethoscope"></i> AI‑Lite Symptom Checker</h2>
    ...
    <section id="records" class="page" aria-labelledby="rec-title">
      ...
      <div class="grid">
        ...
        <div class="card span-4">
          ...
          <label class="muted">Tag<br><input id="recFilter" list="tagOptions" placeholder="e.g., X‑Ray" style="width:100%; padding:10px; border-radius:10px; border:1px solid rgba(255,255,255,.2)"></label>
      ...
      <div class="grid">
        ...
        <div id="dash-meds" class="card span-12">
          ...
          <form id="medForm" class="grid">
            ...
            <div class="card span-3"><label>Dosage / Schedule<br><input name="d" list="medSchedules" placeholder="1 capsule, 3× daily" style="width:100%; padding:10px; border-radius:10px; border:1px solid rgba(255,255,255,.2)"></label></div>
        ...
        <div id="dash-journal" class="card span-12" style="display:none">
          ...
          <div class="row" style="gap:10px; margin-top:12px; flex-wrap:wrap">
            ...
            <div class="row" style="gap:6px">
              <button class="btn ghost" onclick="journalPrevDay()">◀ Prev</button>
              <button class="btn ghost" onclick="journalToday()">Today</button>
              <button class="btn ghost" onclick="journalNextDay()">Next ▶</button>
            </div>
          </div>
    ...
    <section id="mental" class="page" aria-labelledby="mh-title">
      ...
      <div class="grid">
        <div class="card span-6" style="text-align:center">
          <h3><i class="fas fa-wind"></i> Breathing Coach (4‑4‑4)</h3>
          <div class="breath-ball" aria-hidden="true"></div>
          <p class="muted">Inhale 4s → Hold 4s → Exhale 4s. Repeat.</p>
        </div>
        <div class="card span-6">
  ...
  <footer>
    © <span id="year"></span> MediNova — Your smart healthcare companion. This site is for educational purposes only and does not provide medical advice.
  </footer>
...
<div class="sos-modal" id="sosModal">
    <div class="sos-content">
      <button class="sos-close" onclick="closeSOS()">×</button>
...
<script>
  ...
  const dict = {
    en: { 
      ...
      hero:'Your one‑stop smart healthcare companion.', 
      lead:'Book doctors, track health, learn, and get help—securely and accessibly.',
      nav_home:'Home', nav_services:'Services', nav_health:'Health', nav_wellbeing:'Well‑being', nav_resources:'Resources', nav_contact:'Contact', nav_customize:'Customize',
      nav_dashboard:'Dashboard',
      sos_title:'SOS — Call Ambulance'
      // Add more translations as needed
    },
    hi: { 
      tagline:'स्मार्ट देखभाल, आसान क्लिक।', 
      hero:'आपका स्मार्ट हेल्थकेयर साथी, एक ही स्थान पर।', 
      lead:'डॉक्टर बुक करें, स्वास्थ्य ट्रैक करें, सीखें और सहायता पाएं—सुरक्षित और सुलभ।',
      nav_home:'होम', nav_services:'सेवाएँ', nav_health:'स्वास्थ्य', nav_dashboard:'डैशबोर्ड', nav_wellbeing:'कल्याण', nav_resources:'संसाधन', nav_contact:'संपर्क', nav_customize:'अनुकूलन',
      sos_title:'एसओएस — एम्बुलेंस कॉल करें'
      // Add more translations as needed
    }
  };
  ...
  function applyLang(code){
    ...
    if (code === 'hi') {
      document.title = 'MediNova — स्मार्ट स्वास्थ्य सेवा';
    } else {
      document.title = 'MediNova — Smart Healthcare';
    }
  }
  ...
  function updateApptReminders(){
    ...
    rows.forEach(r=>{
      ...
      li.textContent = `${when} — ${r.name} with ${r.doctor||'doctor'} at ${r.hospital||'clinic'} (${r.mode})`;
      el.appendChild(li);
    });
  }
  ...
  function checkSymptoms(){
    ...
    if(s==='Shortness of Breath'){
      tips.push('Potentially serious—use Emergency Mode if acute.');
    }
    tips.forEach(push);
  ...
  function renderICE(){ 
    ...
    (JSON.parse(localStorage.getItem(iceKey)||'[]')).forEach(x=>{ 
      const li=document.createElement('li'); 
      li.innerHTML=`${x.n} — <a href="tel:${x.p}">${x.p}</a> <button class='btn ghost' onclick="delICE('${x.id}')">Delete</button>`; 
      ul.appendChild(li); 
    }); 
  }
  ...
  function exportJournalPDF(){
    ...
    const html=`<html><head><title>Symptoms Journal</title><style>${css}</style></head><body>
      ...
      <div class="muted">Range: ${from||'—'} to ${to||'—'}</div>
  ...
  function renderMoods(){ 
    ...
    (JSON.parse(localStorage.getItem(moodKey)||'[]')).forEach(x=>{ 
      const li=document.createElement('li'); 
      li.textContent=`${new Date(x.t).toLocaleDateString()} — ${x.m} ${x.n? '— '+x.n:''}`; 
      ul.appendChild(li); 
    }); 
  }
